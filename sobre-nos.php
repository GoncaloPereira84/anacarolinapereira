...
<div class="reels-wrapper movement">
    <div id="formacoes">
        <div class="copy-content">
            <h3 class="title main">Clínicas</h3>
            <div class="line"></div>
            <div class="copy">
                <p></p>
                <p>De psicologia. Que desenvolve serviços que vão desde a avaliação psicológica (nas suas mais diversas
                    valências) a consultas de acompanhamento psicoterapêutico. A crianças, jovens e adultos. Uma
                    clínica. De psicologia. Que pretende promover a saúde mental. No espaço da relação. </p>
                <p></p>
            </div>
        </div>
        <div class="cards-wrapper">
            <a title="O Método Rorschach na prática clínica">
                <div class="card" id="coimbra-card"
                    onclick="openModalWithVideo('modal-rorschach')">
                    <div class="card-title">Coimbra</div>
                    <div class="card-copy">
                        <i>
                            <p>De psicologia. Que desenvolve serviços que vão desde a avaliação psicológica (nas suas
                                mais diversas valências) a consultas de acompanhamento psicoterapêutico. A crianças,
                                jovens e adultos. Uma clínica. De psicologia. Que pretende promover a saúde mental. No
                                espaço da relação. </p>
                        </i>
                    </div>
                    <div class="cta">
                ...
                <div class="card"
                    onclick="openModalWithVideo('modal-infancia', 'www.instagram.com/reel/C0Py8Rxsl89/?utm_source=ig_embed&amp;utm_campaign=loading')">
                    ...
                    <div class="card-copy">
                        <i>De psicologia. Que desenvolve serviços que vão desde a avaliação psicológica (nas suas mais
                            ...
                            adultos. Uma clínica. De psicologia. Que pretende promover a saúde mental. No espaço da
                            relação. </i>
                    </div>
                    <div class="cta">
                        <div class="txt">saiba mais</div>
...
<div id="modal-rorschach" class="modal">
    <div class="modal-content">
        ...
        <span class="closee"
            onclick="closeModalAndPauseVideo('modal-rorschach', 'https:www.instagram.com/reel/Cydej3QI20t/?utm_source=ig_embed&amp;utm_campaign=loading')">&times;</span>
...
<div id="modal-infancia" class="modal">
    <div class="modal-content">
        ...
        <span class="closee"
            onclick="closeModalAndPauseVideo('modal-infancia', 'https:www.instagram.com/reel/C0UUnEAMFcH/?utm_source=ig_embed&amp;utm_campaign=loading')">&times;</span>
...
<script>
    $(document).ready(function () {
        // Function to open modal and append blockquote
        function openModalWithBlockquote(modalId, blockquoteContent) {
            // Open the modal
            $('#' + modalId).show();

            // Append the blockquote to the modal content
            $('#' + modalId + ' .modal-content').append(blockquoteContent);
        }

        // Function to close modal and remove blockquote
        function closeModalAndRemoveBlockquote(modalId) {
            // Close the modal
            $('#' + modalId).hide();

            // Remove the blockquote from the modal content
            $('#' + modalId + ' .modal-content blockquote').remove();
        }

        // Click event for the "Coimbra" card
        $('#coimbra-card').click(function () {
            var blockquoteContent = ' <blockquote class="instagram-media"'
            + 'data-instgrm-permalink="https://www.instagram.com/reel/Cydej3QI20t/?utm_source=ig_embed&amp;utm_campaign=loading"'
            + 'data-instgrm-version="14"'
            + 'style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">'
            + '<div style="padding:16px;"> <a'
            + '       href="https://www.instagram.com/reel/Cydej3QI20t/?utm_source=ig_embed&amp;utm_campaign=loading"'
            + '     style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none; width:100%;"'
            + '     target="_blank">'
            + '     <div style=" display: flex; flex-direction: row; align-items: center;">'
            + '         <div'
            ...
            + '                         <path'
               ...
               + '<p'
               + '  style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">'
               + '  <a href="https://www.instagram.com/reel/Cydej3QI20t/?utm_source=ig_embed&amp;utm_campaign=loading"'
               + '      style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"'
               + '      target="_blank">Uma publicação partilhada por Ana Carolina Pereira (@anacarolinapereirapc)</a>'
               + '</p>'
               + '</div>'
               + '</blockquote>';''
               + 'openModalWithBlockquote('modal-rorschach', blockquoteContent);'
               + '});'

        // Click event for the close button in the modal
        $('.closee').click(function () {
            closeModalAndRemoveBlockquote($(this).closest('.modal').attr('id'));
        });
    });
</script>
