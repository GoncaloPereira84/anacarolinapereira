    ...
    <div class="row">
        <div class="col-md-6">
            <blockquote class="instagram-media" data-instgrm-captioned
                ...
                style="background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; min-width:326px; padding:0;">
                <div style="padding:16px;"> <a
                    ...
                    <p
                        ...
                        <a href="https://www.instagram.com/reel/C0Py8Rxsl89/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            target="_blank">Uma publicação compartilhada por Ana Carolina Pereira
                            (@anacarolinapereirapc)</a>
                    </p>
                </div>
            </blockquote>
        </div>
